          ...
          <div className="sh-fix-main">
            ...
            <div className="sh-fix-teams" style={{ flexWrap: 'wrap', rowGap: '6px', columnGap: '10px' }}>
              {/* Home + away are separate nowrap units so long pairings wrap
                  ...
                  left of each name (user request) at 54px. */}
              ...
              <span style={{ display: 'inline-flex', alignItems: 'center', gap: '9px', flexWrap: 'nowrap', minWidth: 0 }}>
                ...
                <TeamBadge logoUrl={game.opponentLogoUrl} abbreviation={game.opponentAbbr} primaryColor={game.opponentColor} size={54} logoFilter={TEAM_LOGO_FILTERS[game.opponentId ?? '']} />
