  ...
  afl: {
    ...
    finalsSchedule: [
      ...
      { name: 'Semi-Final',         from: '2026-09-09',  to: '2026-09-14',
        detail: 'the qualifying-final losers host the elimination-final winners; the winner advances to a preliminary final' },
      { name: 'Preliminary Final',  from: '2026-09-16', to: '2026-09-20',
        detail: 'the qualifying-final winners host the semi-final winners; the winner advances to the Grand Final' },
  ...
  super_rugby: {
    ...
    finalsSchedule: [
      ...
      { name: 'Semi-Final',       from: '2026-06-10', to: '2026-06-15',
        detail: 'the winner advances to the Grand Final' },
